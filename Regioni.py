...
for d in range(0, len(dati_regioni)-1):
    if dati_regioni[d]['denominazione_regione']=='Lombardia':
        ...
        new_lombardia.append(dati_regioni[d]['nuovi_positivi'])
        ...
        new_campania.append(dati_regioni[d]['nuovi_positivi'])
        ...
        new_calabria.append(dati_regioni[d]['nuovi_positivi'])
        ...
        new_veneto.append(dati_regioni[d]['nuovi_positivi'])
...
for i in range(0, len(tot_lombardia)):
    ...
    if tot_calabria[i] != 0:
        ...
        k_new_cal.append(0)
for i in range(0, len(tot_veneto)):
    if tot_veneto[i] != 0:
