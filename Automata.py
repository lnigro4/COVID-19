...
os.system("echo Studio l'andamento nazionale...")
os.system('python3 Nazione.py')
os.system("echo Studio l'andamento regionale...")
os.system('python3 Regione.py')
os.system("echo Studio l'andamento provinciale...")
os.system('python3 Provincia.py')
os.system("echo Studio l'andamento delle 4 regioni preferite...")
